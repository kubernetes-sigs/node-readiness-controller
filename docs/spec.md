...
| `satisfied` _boolean_ | satisfied indicates whether the CurrentStatus matches the RequiredStatus. |  |  |
| `missing` _boolean_ | missing indicates that the specified condition was not found on the Node. |  |  |
